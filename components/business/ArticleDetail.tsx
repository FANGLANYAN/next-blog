...
import { updateArticle, deleteArticle } from "@/lib/service/articleService";
import type { Article } from "@/lib/supabase/constant";
import SimpleMDE from "./SimpleIMDE";

export default function ArticleDetail({ article: initialArticle, catId }: { article: Article; catId: number }) {
